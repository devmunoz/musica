...
public class ListaCancionesDefecto {
	...
	public void addCancionesDefecto() throws IOException {
		...
		addCancionALista("Monster", "Skyllet", "Awake", 2009, "Rock", 
				caratulaByteArray("/canciones/swing/res/1.png"),archivoByteArray(rutaDef + "1.mp3"));
		...
		addCancionALista("El niño güei", "SFDK", "2005", 2005, "Rap", 
				caratulaByteArray("/canciones/swing/res/7.png"),archivoByteArray(rutaDef + "7.mp3"));
		...
		addCancionALista("Blow money fast", "The Zombie Kids", "", 2011, "Electrónica",
		...
		addCancionALista("Air","Johann Sebastian Bach", "", 1723, "Clásica",
				caratulaByteArray("/canciones/swing/default.png"), archivoByteArray(rutaDef+"12.mp3"));
		addCancionALista("Canon in D major","Johann Pachelbel", "", 1680, "Clásica",
				caratulaByteArray("/canciones/swing/default.png"), archivoByteArray(rutaDef+"13.mp3"));
